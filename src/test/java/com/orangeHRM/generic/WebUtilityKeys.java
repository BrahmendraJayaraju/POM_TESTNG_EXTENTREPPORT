...
public class WebUtilityKeys 
{
    ...
    /* ==================== CLICK ==================== */
	    ...
	    public void clickByPartialLinkText(String value) {
	        ...
	        this.driver.findElement(By.partialLinkText(value)).click();
	    }
    ...
    /* ==================== DISPLAY / ENABLE ==================== */
	    ...
	    public boolean isDisplayedByXpath(String value) {
	        this.waitByXpath(value);
	        return this.driver.findElement(By.xpath(value)).isDisplayed();
	    }

	    public boolean isEnabledById(String value) {
	        this.waitById(value);
	        return this.driver.findElement(By.id(value)).isEnabled();
	    }
    ...
    /* ==================== ACTIONS ==================== */
	    ...
	    public void doubleClickByXpath(String value) {
	        ...
	        new Actions(this.driver)
	                .doubleClick(this.driver.findElement(By.xpath(value)))
	                .perform();
	    }
	    ...
	    public void rightClickByXpath(String value) {
	        this.waitByXpath(value);
	        new Actions(this.driver)
	                .contextClick(this.driver.findElement(By.xpath(value)))
	                .perform();
	    }

	    public void pressKeyByXpath(String value, Keys key) {
	        this.waitByXpath(value);
	        this.driver.findElement(By.xpath(value)).sendKeys(key);
	    }
...
public void scrollToElementByXpath(String value) {
    WebElement el = this.driver.findElement(By.xpath(value));
    ((JavascriptExecutor) this.driver)
...
public void assertTextByXpath(String value, String expected) {
    this.waitByXpath(value);
    Assert.assertEquals(
            this.driver.findElement(By.xpath(value)).getText(),
            expected
    );
}
...
public void assertTextById(String value, String expected) {
    this.waitById(value);
    Assert.assertEquals(
            this.driver.findElement(By.id(value)).getText(),
            expected
    );
}
